...
function mapMetaDataInHeader() {
    ...
    tagElement.innerText = 'FullStack Developer';

    let firstName = 'Tomás';
    let lastName = 'Almeida Garrett';
    ...
    let socials = [
        {
            ...
            "value": "https://www.linkedin.com/in/tom%C3%A1s-almeida-garrett-83461a183/"
        },
        {
            "icon": "fa fa-github",
            "value": "https://github.com/TomasAGarrett"
        },
        {
            "icon": "fa fa-medium",
            "value": ""
...
function mapStatsData() {
    let stats = [
        ...
        },
        {
            ...
            "text-2": "in 10+ Languages"
        },
        {
            "value": "2",
            "text-1": "Certifications",
            "text-2": "Obtained"
        }
    ];
